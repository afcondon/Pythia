...
(() => {
  ...
  // output/Demo.HalogenWebSocket/index.js
  ...
  var render = function(state3) {
    ...
    return div2([style("font-family: system-ui; padding: 20px; background: #1a1a2e; color: #eee; min-height: 100vh;")])([h1([style("color: #7c3aed;")])([text5("Halogen WebSocket Demo")]), p([style("color: #888;")])([text5("PureScript Halogen + Python WebSocket Server")]), div2([style("margin: 20px 0;")])([button([onClick(function(v) {
      return Connect.value;
    }), style("padding: 10px 20px; margin-right: 10px; background: #7c3aed; color: white; border: none; border-radius: 6px; cursor: pointer;"), disabled10(state3.status === "Connected")])([text5("Connect")]), button([onClick(function(v) {
      return Disconnect.value;
    }), style("padding: 10px 20px; background: #374151; color: white; border: none; border-radius: 6px; cursor: pointer;"), disabled10(state3.status !== "Connected")])([text5("Disconnect")]), span3([style("margin-left: 20px; padding: 8px 15px; border-radius: 6px; " + statusStyle(state3.status))])([text5(state3.status)])]), p([style("margin: 10px 0; color: #888;")])([text5("Check browser console for messages (open DevTools)")]), p([style("color: #6ee7b7;")])([text5("Message count: " + show2(state3.messageCount))])]);
  };
    ...
    return function(v) {
      if (v instanceof Connect) {
        return discard5(modify_3(function(v1) {
          ...
          return bind5(liftEffect7(create4("ws://localhost:8766")))(function(ws) {
            return discard5(liftEffect7(onOpen(ws)(log("[Halogen] WebSocket OPEN"))))(function() {
              return discard5(liftEffect7(onMessage(ws)(function(event) {
                var msg = getMessageData(event);
                return log("[Halogen] MSG: " + msg);
              })))(function() {
                return discard5(liftEffect7(onClose(ws)(function(event) {
                  return log("[Halogen] CLOSE: " + show2(event.code));
                })))(function() {
                  return discard5(liftEffect7(onError(ws)(log("[Halogen] ERROR"))))(function() {
                    return discard5(modify_3(function(v1) {
                      var $32 = {};
                      for (var $33 in v1) {
                      ...
                      return liftEffect7(log("[Halogen] Connected to ws://localhost:8766"));
                    });
                  });
                });
              });
        ...
        return bind5(get2)(function(state3) {
          return discard5((function() {
            if (state3.ws instanceof Just) {
              return liftEffect7(close2(state3.ws.value0));
            }
            ;
            ...
            ;
            throw new Error("Failed pattern match at Demo.HalogenWebSocket (line 113, column 5 - line 115, column 27): " + [state3.ws.constructor.name]);
          })())(function() {
            return discard5(modify_3(function(v1) {
              var $37 = {};
              for (var $38 in v1) {
              ...
              return liftEffect7(log("[Halogen] Disconnected"));
            });
          });
        });
      }
      ;
      throw new Error("Failed pattern match at Demo.HalogenWebSocket (line 89, column 16 - line 117, column 46): " + [v.constructor.name]);
    };
  };
